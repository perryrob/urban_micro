...
module bottom_wall(){
  SE()
    ...
    color([0,1,0])
    {
      translate([5.5,ft(3),0])
        interior_stud(ft(12),HORIZONTAL_NORTH);
      translate([5.5+ft(8),ft(3),0])
        interior_stud(ft(12),HORIZONTAL_NORTH);
...
module bedroom_wall(){
  /* bottom back wall */
  translate([ft(12)-4,ft(3),ft(9)])
    interior_stud(ft(12),HORIZONTAL_WEST);
  translate([ft(12)-4,ft(3)+ft(12),ft(9)])
    interior_stud(ft(3)-5.5,HORIZONTAL_WEST);
  /* ----------------*/
  translate([ft(12)-4,ft(3),ft(9)+ft(6.75)])
    interior_stud(ft(12),HORIZONTAL_WEST);
  translate([ft(12)-4,ft(3)+ft(12),ft(9)+ft(6.75)])
    interior_stud(ft(3)-5.5,HORIZONTAL_WEST);
  for(i=[0:24:ft(15)]) {
    translate([ft(12)-4,ft(3)+i,ft(9)+1.5])
